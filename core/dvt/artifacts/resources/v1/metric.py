...
node in dvt-ce. Additionally, these classes need to at a minimum support
what is specified in their protocol definitions in dvt-semantic-interfaces.
Their protocol definitions can be found here:
https://github.com/dvt-labs/dvt-semantic-interfaces/blob/main/dbt_semantic_interfaces/protocols/metric.py
"""
